...
**No UI work on \NarrativeBlock.generation_mode === 'assisted'\ ships until this doc is signed.** TA-5's Interpretation panel renders \'template'\ only until governance is adopted. TA-9 is blocked entirely on adoption of this doc.
