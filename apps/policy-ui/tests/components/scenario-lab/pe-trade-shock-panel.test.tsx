...
describe('PeTradeShockPanel', () => {
  it('renders the concept-aligned tariff incidence workspace', async () => {
    ...
    assert.match(markup, /Elasticity sensitivity/)
    assert.match(markup, /0.75x elasticity/)
    assert.match(markup, /Data readiness/)
    assert.match(markup, /Product-partner tariff matrix/)
