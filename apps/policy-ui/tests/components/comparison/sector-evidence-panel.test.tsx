        ...
        common: {
          comparison: {
            ioEvidence: {
              ...
              status: 'Validated',
              note:
                'This panel describes structural sector transmission evidence from the I-O bridge. It is not a macro forecast, scenario delta, or causal effect of the scenarios above.',
