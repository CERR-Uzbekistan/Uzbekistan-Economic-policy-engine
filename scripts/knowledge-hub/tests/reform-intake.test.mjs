...
describe('Knowledge Hub reform intake', () => {
  ...
  it('keeps localized reform digests focused on mechanisms instead of past allocation statistics', async () => {
    ...
    const diagnostics = await buildKnowledgeHubCandidateArtifactWithDiagnostics({
      ...
      fetchImpl: async (url) => {
        ...
        if (sourceUrl.includes('/uz/')) {
          return new Response(`
            <html><body>
              <h1>Қишлоқ хўжалигини молиялаштириш ва аграр соҳани субсидиялаш режалари кўриб чиқилди</h1>
              <p>Давлат раҳбари аграр соҳада субсидиялар ажратиш янги тизими юзасидан тақдимот билан танишди.</p>
              <p>Тақдимот аввалида жорий йилда соҳага йўналтирилган молиявий ресурслар ва уларнинг натижалари ҳақида ахборот берилди.</p>
              <p>Қайд этилганидек, пахтачилик ва ғаллачиликни молиялаштириш, қишлоқ хўжалиги техникалари билан таъминлаш ва сув тежовчи технологияларни жорий этишга жами 29 триллион сўм ажратилди.</p>
              <p>Соҳага 2,35 триллион сўм субсидиялар йўналтирилди.</p>
              <p>Ўз маблағидан пахта етиштирган хўжаликларга пахта қийматининг 10 фоизи миқдорида субсидия ажратилиши натижасида 1,9 триллион сўм ресурс тежалди.</p>
              <p>Келгуси йилда пахта ва ғалла ҳосили, субсидия ва бошқа харажатларга жами 34,2 триллион сўм ажратиш режалаштирилгани маълум қилинди.</p>
              <p>Шу боис, фақат дерегуляция, рақамлаштириш ва соддалаштириш энг тўғри йўл, деди давлатимиз раҳбари.</p>
              <p>Тақдимотда янги қўллаб-қувватлаш механизмлари кўриб чиқилди.</p>
              <p>Ҳозирда фермерларга кредит ажратишда бир хил фоиз ставкаси қўлланмоқда.</p>
              <p>Идораларда такрорланувчи вазифалар мавжудлиги кўрсатиб ўтилди.</p>
              <p>Бу соҳани тубдан ўзгартиришни талаб қилади.</p>
              <p>Уларни тизимлаштириш орқали талабларни мақбуллаштириш мумкинлиги қайд этилди.</p>
              <p>Халқаро тажрибага кўра, бундай чоралар харажатларни камайтиради.</p>
              <p>Қишлоқ хўжалиги вазирлиги ҳузурида Аграр соҳада тўловлар агентлиги ташкил этилди.</p>
              <p>2026 йилда субсидияларни Агросубсидия орқали проактив тарзда бериш тартиби жорий этилади.</p>
              <p>Кредит рейтинги “A” бўлган хўжаликларга ставка 2 фоиз бандига пасайтирилган кредит бериш механизми таклиф этилмоқда.</p>
              <p>Агропортал орқали аризаларни кўриб чиқиш тўлиқ рақамлаштирилади.</p>
            </body></html>
          `)
        }
    ...
    const uzMeasures = diagnostics.artifact.reform_packages[0].localized.parameters_or_amounts.uz
    const joinedUz = uzMeasures.join('\n')

    assert.ok(uzMeasures.some((value) => /Аграр соҳада тўловлар агентлиги ташкил этилди/.test(value)))
    assert.ok(uzMeasures.some((value) => /Агросубсидия орқали проактив тарзда/.test(value)))
    assert.ok(uzMeasures.some((value) => /кредит бериш механизми таклиф этилмоқда/.test(value)))
    assert.ok(uzMeasures.some((value) => /Агропортал орқали.*рақамлаштирилади/.test(value)))
    assert.doesNotMatch(
      joinedUz,
      /тақдимот билан танишди|Тақдимот аввалида|Тақдимотда|кўриб чиқилди|Ҳозирда|ахборот берилди|Қайд этилганидек|қайд этилди|29 триллион|2,35 триллион|1,9 триллион|тежалди|34,2 триллион|маълум қилинди|деди давлатимиз раҳбари|мавжудлиги|кўрсатиб ўтилди|талаб қилади|Халқаро тажрибага кўра/,
    )
    assert.equal(
      diagnostics.artifact.reform_packages[0].localized.digest.uz.changed,
      'Қишлоқ хўжалиги вазирлиги ҳузурида Аграр соҳада тўловлар агентлиги ташкил этилди.',
    )
  })
  ...
  it('assembles configured-source housing and agriculture packages from verified official detail pages', () => {
    ...
    assert.match(packages[1].financing_or_incentive, /Agrosubsidy/)
